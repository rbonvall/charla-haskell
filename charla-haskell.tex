...
\begin{frame}[fragile]
    \begin{block}{¿Qué hace esto?}
        \lstinputlisting[style=c,linerange=11-13]{programas/fold.cpp}
    \end{block}
    \pause
    \begin{block}{¿Y esto?}
...
\begin{frame}[fragile]
    \begin{block}{¿Y esto otro?}
        \lstinputlisting[style=c,linerange=31-33]{programas/fold.cpp}
    \end{block}
    \pause
    \begin{block}{¿Y esto de ac\'a?}
        \lstinputlisting[style=c,linerange=41-43]{programas/fold.cpp}
    \end{block}
\end{frame}
